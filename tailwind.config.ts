...
// Ported verbatim from the Astro build's tailwind.config.mjs. Colors resolve to
// the CSS variables defined in globals.css / public/brand-tokens.css (with hex
// fallbacks) and REPLACE Tailwind's default palette. Keep the navy.700 === --navy
// quirk intact.
const config: Config = {
